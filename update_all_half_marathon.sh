...
# Quick Links HTML snippet for half marathon pages
QUICK_LINKS='
            <!-- Quick Links -->
...
# Find all half marathon pace pages and update them
find /Users/fanqienigehamigua/Documents/marathon/half-marathon-pace-chart-final -name "index.html" -not -path "*/index.html" | while read file; do
    echo "Updating $file"
...
echo "All half marathon pace pages updated!"
